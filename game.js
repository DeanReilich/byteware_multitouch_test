...
tofu_events_EventBase.prototype = {
	...
	,__properties__: {set_dispatchOnce:"set_dispatchOnce",get_dispatchOnce:"get_dispatchOnce",set_isEnabled:"set_isEnabled",get_isEnabled:"get_isEnabled"}
};
...
byteware_geom_Transform.prototype = {
	...
	,__properties__: {set_rad:"set_rad",get_rad:"get_rad",set_deg:"set_deg",get_deg:"get_deg",set_pivotY:"set_pivotY",get_pivotY:"get_pivotY",set_pivotX:"set_pivotX",get_pivotX:"get_pivotX",set_skewY:"set_skewY",get_skewY:"get_skewY",set_skewX:"set_skewX",get_skewX:"get_skewX",set_scaleY:"set_scaleY",get_scaleY:"get_scaleY",set_scaleX:"set_scaleX",get_scaleX:"get_scaleX",set_h:"set_h",get_h:"get_h",set_w:"set_w",get_w:"get_w",set_y:"set_y",get_y:"get_y",set_x:"set_x",get_x:"get_x",set_mat:"set_mat",get_mat:"get_mat",get_onTransform:"get_onTransform"}
};
...
byteware_graphics_RenderObject.prototype = $extend(byteware_geom_Transform.prototype,{
	...
	,__properties__: $extend(byteware_geom_Transform.prototype.__properties__,{set_colorFill:"set_colorFill",get_colorFill:"get_colorFill",set_mask:"set_mask",get_mask:"get_mask",set_alpha:"set_alpha",get_alpha:"get_alpha",set_visibleArea:"set_visibleArea",get_visibleArea:"get_visibleArea",set_isVisible:"set_isVisible",get_isVisible:"get_isVisible",get_onVisChange:"get_onVisChange"})
});
...
DisplayObject.prototype = $extend(byteware_graphics_RenderObject.prototype,{
	...
	,__properties__: $extend(byteware_graphics_RenderObject.prototype.__properties__,{get_onOut:"get_onOut",get_onOver:"get_onOver",get_onTouchEnd:"get_onTouchEnd",get_onTouchBegin:"get_onTouchBegin",get_onRemoved:"get_onRemoved",get_onAdded:"get_onAdded",set_isTouchable:"set_isTouchable",get_isTouchable:"get_isTouchable"})
});
...
DisplayContainer.prototype = $extend(DisplayObject.prototype,{
	...
	,__properties__: $extend(DisplayObject.prototype.__properties__,{set_isTouchGroup:"set_isTouchGroup",get_isTouchGroup:"get_isTouchGroup"})
});
...
Main.preload = function() {
	...
	Res.addTexture("marker","marker.png");
...
Main.precache = function() {
	...
	App.onResize.on(function() {
		Main.debug_text.pos(App.LEFT,App.TOP);
	});
	Main.markers = [];
	var i = 10;
	while(--i > -1) {
		...
		Main.markers[i] = marker;
	}
	App.input.touch.onTouch.on(function(touch) {
		var text = "";
		if(touch.id == 0) {
		...
		if(marker1 != null) {
			marker1.set_isVisible(touch.isDown);
			marker1.pos(touch.x,touch.y);
		}
	});
};
...
Sprite.prototype = $extend(DisplayObject.prototype,{
	...
	,__class__: Sprite
	,__properties__: $extend(DisplayObject.prototype.__properties__,{set_useTexturePivot:"set_useTexturePivot",get_useTexturePivot:"get_useTexturePivot",set_texture:"set_texture",get_texture:"get_texture"})
});
var Marker = function() {
	Sprite.call(this,Res.getTexture("marker"));
	this.set_isVisible(false);
	this.anchor(.5,.5);
	App.ticker.add($bind(this,this.update));
};
Marker.__name__ = ["Marker"];
Marker.__super__ = Sprite;
Marker.prototype = $extend(Sprite.prototype,{
	update: function(delta) {
		var _g = this;
		_g.set_deg(_g.get_deg() + 360 * delta);
	}
	,__class__: Marker
});
Math.__name__ = ["Math"];
...
ReflectTools.setField = function(object,field,value,isField) {
	if(isField == null) {
		isField = true;
	}
	if(isField) {
...
TextField.prototype = $extend(DisplayObject.prototype,{
	...
	,__class__: TextField
	,__properties__: $extend(DisplayObject.prototype.__properties__,{set_offsetY:"set_offsetY",get_offsetY:"get_offsetY",set_offsetX:"set_offsetX",get_offsetX:"get_offsetX",set_isWrappingEnabled:"set_isWrappingEnabled",get_isWrappingEnabled:"get_isWrappingEnabled",set_size:"set_size",get_size:"get_size",set_verSpace:"set_verSpace",get_verSpace:"get_verSpace",set_horSpace:"set_horSpace",get_horSpace:"get_horSpace",set_align:"set_align",get_align:"get_align",set_text:"set_text",get_text:"get_text",set_font:"set_font",get_font:"get_font"})
});
var Type = function() { };
Type.__name__ = ["Type"];
...
var byteware_Input = function() {
	this.touch = new byteware_input_TouchProcessor();
};
byteware_Input.__name__ = ["byteware","Input"];
byteware_Input.prototype = {
	__class__: byteware_Input
};
...
byteware_RootContainer.prototype = $extend(DisplayContainer.prototype,{
	...
	,submitTouch: function(id,x,y,state) {
		this.c_mat.inv_transformCoords(x,y,this.pointer);
		if(this.pointer.x < App.LEFT) {
			this.pointer.x = App.LEFT;
		} else if(this.pointer.x > App.RIGHT) {
			this.pointer.x = App.RIGHT;
		}
		if(this.pointer.y < App.TOP) {
			this.pointer.y = App.TOP;
		} else if(this.pointer.y > App.BOTTOM) {
			this.pointer.y = App.BOTTOM;
		}
		if(!App.input.touch.submitTouch(id,this.pointer.x,this.pointer.y,state)) {
			return false;
		}
		var object = null;
		var i = this.numChildren;
...
byteware_Ticker.__properties__ = {set_globalScale:"set_globalScale",get_globalScale:"get_globalScale"};
...
byteware_Ticker.prototype = {
	...
	,__properties__: {set_scale:"set_scale",get_scale:"get_scale",set_isPaused:"set_isPaused",get_isPaused:"get_isPaused"}
};
...
byteware_assets_Asset.prototype = {
	...
	,__properties__: {get_onDispose:"get_onDispose",get_onReloaded:"get_onReloaded"}
};
...
byteware_assets_AssetPack.prototype = {
	...
	,__properties__: {get_numLoaded:"get_numLoaded",get_isLoaded:"get_isLoaded"}
};
...
byteware_geom_Rect.prototype = {
	...
	,__properties__: {set_b:"set_b",get_b:"get_b",set_t:"set_t",get_t:"get_t",set_r:"set_r",get_r:"get_r",set_l:"set_l",get_l:"get_l"}
};
...
byteware_graphics_ColorFill.prototype = {
	...
	,__properties__: {set_intensity:"set_intensity",get_intensity:"get_intensity",set_b:"set_b",get_b:"get_b",set_g:"set_g",get_g:"get_g",set_r:"set_r",get_r:"get_r"}
};
...
byteware_graphics_Mask.prototype = $extend(byteware_geom_Transform.prototype,{
	...
	,__properties__: $extend(byteware_geom_Transform.prototype.__properties__,{set_useTexturePivot:"set_useTexturePivot",get_useTexturePivot:"get_useTexturePivot",set_isInverted:"set_isInverted",get_isInverted:"get_isInverted",set_texture:"set_texture",get_texture:"get_texture"})
});
...
var byteware_input_Touch = function(touch_id) {
	this.id = touch_id;
	this.x = this.y = 0.0;
	this.isDown = false;
	this.state = byteware_input_TouchState.END;
};
byteware_input_Touch.__name__ = ["byteware","input","Touch"];
byteware_input_Touch.prototype = {
	set: function(touch_x,touch_y,touch_state) {
		this.x = touch_x;
		this.y = touch_y;
		this.state = touch_state;
		this.isDown = touch_state == byteware_input_TouchState.BEGIN || touch_state == byteware_input_TouchState.MOVE;
	}
	,release: function() {
	}
...
var byteware_input_TouchProcessor = function() {
	...
	this.onTouch = new tofu_events_Event1(null,false,false,false);
};
byteware_input_TouchProcessor.__name__ = ["byteware","input","TouchProcessor"];
byteware_input_TouchProcessor.prototype = {
	submitTouch: function(id,x,y,state) {
		if(id >= this.c_num_touches) {
			return false;
		}
		var touch = this.c_touches[id];
		touch.set(x,y,state);
		this.onTouch.dispatch(touch,false,false);
		return true;
	}
	,update_touch_count: function() {
		var i = 10;
		while(--i > -1) if(i < this.c_num_touches) {
			break;
		} else {
			this.c_touches[i].release();
		}
	}
	,get_numTouches: function() {
		return this.c_num_touches;
	}
	,set_numTouches: function(val) {
		if(val < 1) {
			val = 1;
		} else if(val > 10) {
			val = 10;
		}
		if(val != this.c_num_touches) {
			this.c_num_touches = val;
			this.update_touch_count();
		}
		return val;
	}
	,__class__: byteware_input_TouchProcessor
	,__properties__: {set_numTouches:"set_numTouches",get_numTouches:"get_numTouches"}
};
...
byteware_media_MixerChannel.prototype = {
	...
	,__properties__: {set_fadeTime:"set_fadeTime",get_fadeTime:"get_fadeTime",set_vol:"set_vol",get_vol:"get_vol",set_isMuted:"set_isMuted",get_isMuted:"get_isMuted",set_isPaused:"set_isPaused",get_isPaused:"get_isPaused"}
};
...
platform_Display.prototype = {
	...
	,__properties__: {get_isFullscreenSupported:"get_isFullscreenSupported",get_h:"get_h",get_w:"get_w"}
};
...
platform_Platform.prototype = {
	...
	,__properties__: {get_storage:"get_storage",get_loader:"get_loader",get_sound:"get_sound",get_renderer:"get_renderer",get_display:"get_display"}
};
...
platform_SoundAsset.prototype = $extend(byteware_assets_Asset.prototype,{
	...
	,__properties__: $extend(byteware_assets_Asset.prototype.__properties__,{set_loop:"set_loop",get_loop:"get_loop",set_vol:"set_vol",get_vol:"get_vol",set_isPaused:"set_isPaused",get_isPaused:"get_isPaused"})
});
...
platform_TextureAsset.prototype = $extend(byteware_assets_Asset.prototype,{
	...
	,__properties__: $extend(byteware_assets_Asset.prototype.__properties__,{get_context:"get_context"})
});
...
platform_html5_CanvasContext.prototype = $extend(platform_Context.prototype,{
	...
	,transform: function(a,b,c,d,e,f) {
		this.backbuffer_ctx.transform(a,b,c,d,e,f);
	}
	,translate: function(x,y) {
		this.backbuffer_ctx.translate(x,y);
	}
	,scale: function(x,y) {
		this.backbuffer_ctx.scale(x,y);
	}
	,rotate_rad: function(angle) {
		this.backbuffer_ctx.rotate(angle);
	}
	,adjustAlpha: function(coef) {
	...
	requestFullscreen: function(state) {
		...
		if(state) {
			...
			if(request == null) {
				...
				this.requestOrientation(this.orientation);
			}
		} else {
...
var tofu_events_Event1 = function(a,auto_dispatch,is_enabled,dispatch_once) {
	if(dispatch_once == null) {
		dispatch_once = false;
	}
	if(is_enabled == null) {
	...
	if(auto_dispatch == null) {
		auto_dispatch = false;
	}
	tofu_events_EventBase.call(this,is_enabled,dispatch_once);
	this.c_auto_dispatch = auto_dispatch;
	this.c_a = a;
};
tofu_events_Event1.__name__ = ["tofu","events","Event1"];
tofu_events_Event1.__super__ = tofu_events_EventBase;
tofu_events_Event1.prototype = $extend(tofu_events_EventBase.prototype,{
	dispatch: function(a,enable,remove_listeners) {
		if(remove_listeners == null) {
			remove_listeners = false;
		}
		if(enable == null) {
	...
	,execute_listener: function(listener) {
		ReflectTools.call(listener,[this.c_a]);
	}
	,get_autoDispatch: function() {
		return this.c_auto_dispatch;
	}
	,set_autoDispatch: function(val) {
		return this.c_auto_dispatch = val;
	}
	,get_a: function() {
		return this.c_a;
	}
	,set_a: function(val) {
		if(this.c_auto_dispatch && this.c_a != val) {
			this.c_a = val;
			this.execute_all();
		}
		return this.c_a = val;
	}
	,__class__: tofu_events_Event1
	,__properties__: $extend(tofu_events_EventBase.prototype.__properties__,{set_a:"set_a",get_a:"get_a",set_autoDispatch:"set_autoDispatch",get_autoDispatch:"get_autoDispatch"})
});
var $_, $fid = 0;
